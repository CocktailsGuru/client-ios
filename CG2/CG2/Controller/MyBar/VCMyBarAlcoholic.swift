...
class VCMyBarAlcoholic: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout  {
    ...
    override func viewDidLoad() {
        // SERVER DATA
        IngredientService.instance.findAllAlcoIngredients { (success) in
            //           print("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@")
            //           print(IngredientService.instance.ingredientDetailMyBarStructs.count)
            self.ingredientAlcoDetailMyBarStructs = IngredientService.instance.ingredientAlcoDetailMyBarStructs
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        var Alco: IngredientDetailMyBarStruct!
        Alco = ingredientAlcoDetailMyBarStructs[indexPath.row]
    ...
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        //return movie.count
        return self.ingredientAlcoDetailMyBarStructs.count
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if let vCMyBarAlcoholicDetail = segue.destination as? VCMyBarAlcoholicDetail{
            ...
            if let ingredientDetailMyBarStruct = sender as? IngredientDetailMyBarStruct {
                vCMyBarAlcoholicDetail.ingredientDetailMyBarStruct = ingredientDetailMyBarStruct
